...
class myMatrix:
    def __init__(self):
        ...
        self.matrixRow = 0
        self.matrixCol = 0
        self.subMatrix = rospy.Subscriber("floatsA", numpy_msg(Floats), self.callback)
        self.subRow = rospy.Subscriber("rowA", Int16, self.grabRow)
        self.subCol = rospy.Subscriber("colA", Int16, self.grabCol)
