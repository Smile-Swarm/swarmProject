...
def callback(msg):
    ...
    ox1 = msg.pose.pose.orientation.x
    oy1 = msg.pose.pose.orientation.y
    oz1 = msg.pose.pose.orientation.z
    ow1 = msg.pose.pose.orientation.w
...
while not rospy.is_shutdown():
    ...
    #pose_msg.pose.pose.orientation.x = ox1
    #pose_msg.pose.pose.orientation.y = oy1
    #pose_msg.pose.pose.orientation.z = oz1
    #pose_msg.pose.pose.orientation.w = ow1
